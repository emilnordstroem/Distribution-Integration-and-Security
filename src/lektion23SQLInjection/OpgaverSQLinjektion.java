...
public class OpgaverSQLinjektion {
    public static void main(String[] args) {
        ...
        try {
            ...
            minConnection = DriverManager.getConnection("jdbc:sqlserver://localhost\\SQLEXPRESS;databaseName=DIS_Lektion23_Injection;user=sa;password=131202;");
